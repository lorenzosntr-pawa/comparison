...
MARKET_MAPPINGS: tuple[MarketMapping, ...] = (
    ...
    # === Combo Markets with O/U Line Parameter ===
    # These markets combine two concepts (e.g., 1X2 + Over/Under) and have a line parameter
    ...
    MarketMapping(
        ...
        bet9ja_key="S_1X2OU",
        outcome_mapping=(
            OutcomeMapping(canonical_id="home_over", betpawa_name=None, sportybet_desc="Home & Over", bet9ja_suffix="1O", position=0),
            OutcomeMapping(canonical_id="home_under", betpawa_name=None, sportybet_desc="Home & Under", bet9ja_suffix="1U", position=1),
            OutcomeMapping(canonical_id="draw_over", betpawa_name=None, sportybet_desc="Draw & Over", bet9ja_suffix="XO", position=2),
            OutcomeMapping(canonical_id="draw_under", betpawa_name=None, sportybet_desc="Draw & Under", bet9ja_suffix="XU", position=3),
            OutcomeMapping(canonical_id="away_over", betpawa_name=None, sportybet_desc="Away & Over", bet9ja_suffix="2O", position=4),
            OutcomeMapping(canonical_id="away_under", betpawa_name=None, sportybet_desc="Away & Under", bet9ja_suffix="2U", position=5),
        ),
    ),

    MarketMapping(
        canonical_id="double_chance_over_under_ft",
        name="Double Chance & Over/Under - Full Time",
        betpawa_id=None,  # Not on BetPawa
        sportybet_id="547",
        bet9ja_key="S_DCOU",
        outcome_mapping=(
            OutcomeMapping(canonical_id="home_draw_over", betpawa_name=None, sportybet_desc="Home or Draw & Over", bet9ja_suffix="1XO", position=0),
            OutcomeMapping(canonical_id="home_draw_under", betpawa_name=None, sportybet_desc="Home or Draw & Under", bet9ja_suffix="1XU", position=1),
            OutcomeMapping(canonical_id="draw_away_over", betpawa_name=None, sportybet_desc="Draw or Away & Over", bet9ja_suffix="X2O", position=2),
            OutcomeMapping(canonical_id="draw_away_under", betpawa_name=None, sportybet_desc="Draw or Away & Under", bet9ja_suffix="X2U", position=3),
            OutcomeMapping(canonical_id="home_away_over", betpawa_name=None, sportybet_desc="Home or Away & Over", bet9ja_suffix="12O", position=4),
            OutcomeMapping(canonical_id="home_away_under", betpawa_name=None, sportybet_desc="Home or Away & Under", bet9ja_suffix="12U", position=5),
        ),
    ),

    MarketMapping(
        canonical_id="htft_over_under_ft",
        name="Halftime/Fulltime & Over/Under - Full Time",
        betpawa_id=None,  # Not on BetPawa
        sportybet_id="818",
        bet9ja_key=None,  # Bet9ja has separate HTFTOU market
        outcome_mapping=(
            # 9 HT/FT outcomes x 2 O/U options = 18 outcomes
            OutcomeMapping(canonical_id="1_1_over", betpawa_name=None, sportybet_desc="Home/Home & Over", bet9ja_suffix=None, position=0),
            OutcomeMapping(canonical_id="1_1_under", betpawa_name=None, sportybet_desc="Home/Home & Under", bet9ja_suffix=None, position=1),
            OutcomeMapping(canonical_id="1_x_over", betpawa_name=None, sportybet_desc="Home/Draw & Over", bet9ja_suffix=None, position=2),
            OutcomeMapping(canonical_id="1_x_under", betpawa_name=None, sportybet_desc="Home/Draw & Under", bet9ja_suffix=None, position=3),
            OutcomeMapping(canonical_id="1_2_over", betpawa_name=None, sportybet_desc="Home/Away & Over", bet9ja_suffix=None, position=4),
            OutcomeMapping(canonical_id="1_2_under", betpawa_name=None, sportybet_desc="Home/Away & Under", bet9ja_suffix=None, position=5),
            OutcomeMapping(canonical_id="x_1_over", betpawa_name=None, sportybet_desc="Draw/Home & Over", bet9ja_suffix=None, position=6),
            OutcomeMapping(canonical_id="x_1_under", betpawa_name=None, sportybet_desc="Draw/Home & Under", bet9ja_suffix=None, position=7),
            OutcomeMapping(canonical_id="x_x_over", betpawa_name=None, sportybet_desc="Draw/Draw & Over", bet9ja_suffix=None, position=8),
            OutcomeMapping(canonical_id="x_x_under", betpawa_name=None, sportybet_desc="Draw/Draw & Under", bet9ja_suffix=None, position=9),
            OutcomeMapping(canonical_id="x_2_over", betpawa_name=None, sportybet_desc="Draw/Away & Over", bet9ja_suffix=None, position=10),
            OutcomeMapping(canonical_id="x_2_under", betpawa_name=None, sportybet_desc="Draw/Away & Under", bet9ja_suffix=None, position=11),
            OutcomeMapping(canonical_id="2_1_over", betpawa_name=None, sportybet_desc="Away/Home & Over", bet9ja_suffix=None, position=12),
            OutcomeMapping(canonical_id="2_1_under", betpawa_name=None, sportybet_desc="Away/Home & Under", bet9ja_suffix=None, position=13),
            OutcomeMapping(canonical_id="2_x_over", betpawa_name=None, sportybet_desc="Away/Draw & Over", bet9ja_suffix=None, position=14),
            OutcomeMapping(canonical_id="2_x_under", betpawa_name=None, sportybet_desc="Away/Draw & Under", bet9ja_suffix=None, position=15),
            OutcomeMapping(canonical_id="2_2_over", betpawa_name=None, sportybet_desc="Away/Away & Over", bet9ja_suffix=None, position=16),
            OutcomeMapping(canonical_id="2_2_under", betpawa_name=None, sportybet_desc="Away/Away & Under", bet9ja_suffix=None, position=17),
        ),
    ),

    MarketMapping(
        canonical_id="over_under_btts_ft",
        name="Over/Under & GG/NG - Full Time",
        betpawa_id=None,  # Not on BetPawa
        sportybet_id="36",
        bet9ja_key=None,  # Bet9ja has separate GGNGOU market (without line param)
        outcome_mapping=(
            OutcomeMapping(canonical_id="over_yes", betpawa_name=None, sportybet_desc="Over & Yes", bet9ja_suffix=None, position=0),
            OutcomeMapping(canonical_id="over_no", betpawa_name=None, sportybet_desc="Over & No", bet9ja_suffix=None, position=1),
            OutcomeMapping(canonical_id="under_yes", betpawa_name=None, sportybet_desc="Under & Yes", bet9ja_suffix=None, position=2),
            OutcomeMapping(canonical_id="under_no", betpawa_name=None, sportybet_desc="Under & No", bet9ja_suffix=None, position=3),
        ),
    ),
)
